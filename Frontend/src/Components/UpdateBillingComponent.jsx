...
class UpdateBillingComponent extends Component {
  constructor(props) {
    super(props);
  ...
  updateBilling = (e) => {
    ...
    BillingService.updateBilling(billing, this.state.id).then((res) => {
...
export default UpdateBillingComponent;
